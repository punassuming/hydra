...
- `.github/workflows/container-images.yml` publishes the four deployable images
  to GHCR under an explicit workflow-dispatch version; never publish an
  implicit `latest` release for the homelab deployment.
